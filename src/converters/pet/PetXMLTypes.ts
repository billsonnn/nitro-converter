export class AssetsXML {
    ...
    private readonly _palettes: Array<PaletteXML>;
    ...
    constructor(assetsXML: any) {
        ...
        this._palettes = new Array<PaletteXML>();
        if (assetsXML.assets.palette !== undefined)
            for (const palette of assetsXML.assets.palette) {
                this._palettes.push(new PaletteXML(palette));
            }
    }
...
export class PaletteXML {
    ...
    constructor(paletteXML: any) {
        const attributes = paletteXML.$;

        this._id = attributes.id;
        this._source = attributes.source;
        this._color1 = attributes.color1;
        this._color2 = attributes.color2;
    }
